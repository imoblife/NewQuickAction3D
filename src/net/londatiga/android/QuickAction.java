...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public View getActionIconView(int index) {
		View v = getActionView(index);
		return v.findViewById(R.id.iv_icon);
	}

	public View getActionTitleView(int index) {
		View v = getActionView(index);
		return v.findViewById(R.id.tv_title);
	}
